...
const songs = [
  ...
  { title: "Interior del Monte Pírico", file: "songs/main/hoenn/monte-pirico-interior.mp3", image: "images/monte-pirico-interior.png", group: "main", region: "Hoenn" },
  ...
  { title: "Escuela de Entrenadores", file: "songs/main/alola/escuela-de-entrenadores.mp3", image: "images/escuela-de-entrenadores.png", group: "main", region: "Alola" },
  ...
  { title: "Aquiles / Magno", file: "songs/main/combate/magno-aquiles.mp3", image: "images/magno-aquiles.png", group: "combat", region: "Combate" },
  ...
  { title: "Aventuras en Teselia",                  file: "songs/other/openings/españa/aventuras-en-teselia.mp3",                image: "images/aventuras-en-teselia.png",                group: "other", other: "openings-anime", sonidexId: "aventuras-en-teselia" },
  ...
  { title: "¡Atrápalos Ya!",                      file: "songs/other/openings/latino/hazte-con-todos-latino.mp3",                     image: "images/hazte-con-todos.png",                     group: "other", other: "openings-anime", sonidexId: "hazte-con-todos", variant: "latino" },
  { title: "¡Liga Naranja!",                      file: "songs/other/openings/latino/aventuras-en-las-islas-naranja-latino.mp3",      image: "images/aventuras-en-las-islas-naranja.png",      group: "other", other: "openings-anime", sonidexId: "aventuras-en-las-islas-naranja", variant: "latino" },
  { title: "¡Los Viajes Johto!",                  file: "songs/other/openings/latino/los-viajes-johto-latino.mp3",                    image: "images/los-viajes-johto.png",                    group: "other", other: "openings-anime", sonidexId: "los-viajes-johto", variant: "latino" },
  { title: "¡Los Campeones de la Liga Johto!",    file: "songs/other/openings/latino/los-campeones-de-la-liga-de-johto-latino.mp3",   image: "images/los-campeones-de-la-liga-de-johto.png",   group: "other", other: "openings-anime", sonidexId: "los-campeones-de-la-liga-de-johto", variant: "latino" },
  { title: "¡La Búsqueda del Maestro!",           file: "songs/other/openings/latino/master-quest-latino.mp3",                        image: "images/master-quest.png",                        group: "other", other: "openings-anime", sonidexId: "master-quest", variant: "latino" },
  { title: "¡Fuerza Máxima!",                     file: "songs/other/openings/latino/advanced-latino.mp3",                            image: "images/advanced.png",                            group: "other", other: "openings-anime", sonidexId: "advanced", variant: "latino" },
  { title: "¡Reto Máximo!",                       file: "songs/other/openings/latino/advanced-challenge-latino.mp3",                  image: "images/advanced-challenge.png",                  group: "other", other: "openings-anime", sonidexId: "advanced-challenge", variant: "latino" },
  { title: "¡Batalla Avanzada!",                  file: "songs/other/openings/latino/advanced-battle-latino.mp3",                     image: "images/advanced-battle.png",                     group: "other", other: "openings-anime", sonidexId: "advanced-battle", variant: "latino" },
  { title: "¡Batalla de la Frontera!",            file: "songs/other/openings/latino/battle-frontier-latino.mp3",                     image: "images/battle-frontier.png",                     group: "other", other: "openings-anime", sonidexId: "battle-frontier", variant: "latino" },
  { title: "¡Diamante y Perla!",                  file: "songs/other/openings/latino/diamante-perla-latino.mp3",                      image: "images/diamante-perla.png",                      group: "other", other: "openings-anime", sonidexId: "diamante-perla", variant: "latino" },
  { title: "¡Dimensión de Batalla!",              file: "songs/other/openings/latino/battle-dimension-latino.mp3",                    image: "images/battle-dimension.png",                    group: "other", other: "openings-anime", sonidexId: "battle-dimension", variant: "latino" },
  { title: "¡Batallas Galácticas!",               file: "songs/other/openings/latino/combates-galacticos-latino.mp3",                 image: "images/combates-galacticos.png",                 group: "other", other: "openings-anime", sonidexId: "combates-galacticos", variant: "latino" },
  { title: "¡Los Vencedores de la Liga Sinnoh!",  file: "songs/other/openings/latino/los-vencedores-de-la-liga-de-sinnoh-latino.mp3", image: "images/los-vencedores-de-la-liga-de-sinnoh.png", group: "other", other: "openings-anime", sonidexId: "los-vencedores-de-la-liga-de-sinnoh", variant: "latino" },
  { title: "¡Blanco y Negro!",                    file: "songs/other/openings/latino/negro-y-blanco-latino.mp3",                      image: "images/negro-y-blanco.png",                      group: "other", other: "openings-anime", sonidexId: "negro-y-blanco", variant: "latino" },
  { title: "¡Destinos Rivales!",                  file: "songs/other/openings/latino/destinos-rivales-latino.mp3",                    image: "images/destinos-rivales.png",                    group: "other", other: "openings-anime", sonidexId: "destinos-rivales", variant: "latino" },
  { title: "¡Aventuras en Teselia!",                file: "songs/other/openings/latino/aventuras-en-teselia-latino.mp3",                image: "images/aventuras-en-teselia.png",                group: "other", other: "openings-anime", sonidexId: "aventuras-en-teselia", variant: "latino" },
  { title: "¡XY Kalos Quest!",                    file: "songs/other/openings/latino/expediciones-en-kalos-latino.mp3",               image: "images/expediciones-en-kalos.png",               group: "other", other: "openings-anime", sonidexId: "expediciones-en-kalos", variant: "latino" },
  ...
  { title: "Indigo League",                       file: "songs/other/openings/english/hazte-con-todos-ingles.mp3",                     image: "images/hazte-con-todos.png",                     group: "other", other: "openings-anime", sonidexId: "hazte-con-todos", variant: "english" },
  { title: "Adventures in the Orange Islands",    file: "songs/other/openings/english/aventuras-en-las-islas-naranja-ingles.mp3",      image: "images/aventuras-en-las-islas-naranja.png",      group: "other", other: "openings-anime", sonidexId: "aventuras-en-las-islas-naranja", variant: "english" },
  { title: "The Johto Journeys",                  file: "songs/other/openings/english/los-viajes-johto-ingles.mp3",                    image: "images/los-viajes-johto.png",                    group: "other", other: "openings-anime", sonidexId: "los-viajes-johto", variant: "english" },
  { title: "Johto League Champions",              file: "songs/other/openings/english/los-campeones-de-la-liga-de-johto-ingles.mp3",   image: "images/los-campeones-de-la-liga-de-johto.png",   group: "other", other: "openings-anime", sonidexId: "los-campeones-de-la-liga-de-johto", variant: "english" },
  { title: "Master Quest",                        file: "songs/other/openings/english/master-quest-ingles.mp3",                        image: "images/master-quest.png",                        group: "other", other: "openings-anime", sonidexId: "master-quest", variant: "english" },
  { title: "Advanced",                            file: "songs/other/openings/english/advanced-ingles.mp3",                            image: "images/advanced.png",                            group: "other", other: "openings-anime", sonidexId: "advanced", variant: "english" },
  { title: "Advanced Challenge",                  file: "songs/other/openings/english/advanced-challenge-ingles.mp3",                  image: "images/advanced-challenge.png",                  group: "other", other: "openings-anime", sonidexId: "advanced-challenge", variant: "english" },
  { title: "Advanced Battle",                     file: "songs/other/openings/english/advanced-battle-ingles.mp3",                     image: "images/advanced-battle.png",                     group: "other", other: "openings-anime", sonidexId: "advanced-battle", variant: "english" },
  { title: "Battle Frontier",                     file: "songs/other/openings/english/battle-frontier-ingles.mp3",                     image: "images/battle-frontier.png",                     group: "other", other: "openings-anime", sonidexId: "battle-frontier", variant: "english" },
  { title: "Diamond and Pearl",                   file: "songs/other/openings/english/diamante-perla-ingles.mp3",                      image: "images/diamante-perla.png",                      group: "other", other: "openings-anime", sonidexId: "diamante-perla", variant: "english" },
  { title: "Battle Dimension",                    file: "songs/other/openings/english/battle-dimension-ingles.mp3",                    image: "images/battle-dimension.png",                    group: "other", other: "openings-anime", sonidexId: "battle-dimension", variant: "english" },
  { title: "Galactic Battles",                    file: "songs/other/openings/english/combates-galacticos-ingles.mp3",                 image: "images/combates-galacticos.png",                 group: "other", other: "openings-anime", sonidexId: "combates-galacticos", variant: "english" },
  { title: "Sinnoh League Victors",               file: "songs/other/openings/english/los-vencedores-de-la-liga-de-sinnoh-ingles.mp3", image: "images/los-vencedores-de-la-liga-de-sinnoh.png", group: "other", other: "openings-anime", sonidexId: "los-vencedores-de-la-liga-de-sinnoh", variant: "english" },
  { title: "Black & White",                       file: "songs/other/openings/english/negro-y-blanco-ingles.mp3",                      image: "images/negro-y-blanco.png",                      group: "other", other: "openings-anime", sonidexId: "negro-y-blanco", variant: "english" },
  { title: "Rival Destinies",                     file: "songs/other/openings/english/destinos-rivales-ingles.mp3",                    image: "images/destinos-rivales.png",                    group: "other", other: "openings-anime", sonidexId: "destinos-rivales", variant: "english" },
  { title: "Adventures in Unova",                 file: "songs/other/openings/english/aventuras-en-teselia-ingles.mp3",                image: "images/aventuras-en-teselia.png",                group: "other", other: "openings-anime", sonidexId: "aventuras-en-teselia", variant: "english" },
  { title: "XY Kalos Quest",                      file: "songs/other/openings/english/expediciones-en-kalos-ingles.mp3",               image: "images/expediciones-en-kalos.png",               group: "other", other: "openings-anime", sonidexId: "expediciones-en-kalos", variant: "english" },
];
...
const AVATAR_UNLOCKS = {
  ...
  magearna:   { achId: "perfect_regions_normal_5" },
  terrakion:  { achId: "story_teselia"            },
  virizion:   { achId: "story_teselia"            },
  cobalion:   { achId: "story_teselia"            },
  volcanion:  { achId: "story_kalos"              },
  zacian:     { achId: "story_complete_100"       },
  zamazenta:  { achId: "story_complete_100"       },
  calyrex:    { achId: "sonidex_200"              },
  spectrier:  { achId: "sonidex_100"              },
  glastrier:  { achId: "sonidex_100"              },
  regieleki:  { achId: "sonidex_50"               },
